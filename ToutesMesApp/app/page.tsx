...
import Filters, { type FiltersState } from "@/app/components/Filters";
...
const DEFAULT_FILTERS: FiltersState = {
  // On initialise avec les clés connues pour éviter des "undefined" et garder du typage strict
...
export default function Home() {
  ...
  const filteredProjects = useMemo(() => {
    ...
    const activeCats = (Object.entries(filters.categories) as [ProjectCategory, boolean][])
      .filter(([, isChecked]) => isChecked)
      .map(([cat]) => cat);
